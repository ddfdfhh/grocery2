...
class AttributeController extends Controller
{
    public function __construct()
    {
        ...
        $this->index_url=route('attributes.index');
    ...
    [
        ...
        'inputs' => [
            ...
            [
                ...
                'tag' => 'select',
                'type' => 'select',
                'default' => isset($model) && isset($model->attribute_id) ?formatDefaultValueForEdit($model,'attribute_id', false):(!empty(getList('Attribute'))?getList('Attribute')[0]->id:''),
                'attr' => [],
