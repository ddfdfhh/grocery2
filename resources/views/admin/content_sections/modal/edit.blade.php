                    ...
                    <div class="card-body">
                        <div class="card-text">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="color" name="background_color" value="{{ $model->background_color }}"
                                    class="form-control" />
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="color" name="section_background_color" value="{{ $model->section_background_color }}"
                                    class="form-control" />
