                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    <label class="form-label" for="product-title-input">Brand <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label" for="product-title-input">Price Per Unit<span class="text-danger">*</span></label>


                                    <div class="input-group has-validation mb-3">
                                        <span class="input-group-text" id="produect-price-addon">{{getCurrency()}}</span>
                                        <input required type="number" class="form-control" name="price" id="product-price-input"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label" for="product-title-input">Selling Price<span class="text-danger">*</span></label>

                                    <div class="input-group has-validation mb-3">
                                        <span class="input-group-text" id="pr3oduct-price-addon">$</span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <label class="form-label" for="product-title-input">Quantity in Stock <span class="text-danger">*</span></label>
                           ...
                           {{-- <div class="col-md-6 mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label" for="product-title-input">Per Quantity of <span class="text-danger">*</span></label>
                                    <div class="d-flex">
                                        ...
                                        <input type="number" name="per_price"  class="form-control" style="border-left:0;border-top-left-radius:0;border-bottom-left-radius:0" name="per_price" value=""
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label" for="stocks-input">Max Purchase Quantity Allowed <span class="text-danger">*</span></label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex  justify-content-between">
                            <div class="form-group w-50">
                                ...
                                <textarea  class="form-control" name="features" placeholder="Enter Product feratures or benefits"
                                    rows="3"></textarea>
                            ...
                            <div class="form-group w-50">
                                ...
                                <textarea  class="form-control" name="specifications" placeholder="Enter Product specification"
                                    rows="3"></textarea>
